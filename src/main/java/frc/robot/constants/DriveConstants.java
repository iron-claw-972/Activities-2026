...
public class DriveConstants {
  ...
  public static final double DISTANCE_PER_MOTOR_ROTATION =
  ...
  public static final DCMotor MOTOR =
      DCMotor.getNEO(LEFT_MOTOR_2_ID < 0 ? 1 : 2);
  ...
  public static final double V =
      2 * GEAR_RATIO / WHEEL_DIAMETER / MOTOR.KvRadPerSecPerVolt;

  public static final double A =
      1 / (GEAR_RATIO / WHEEL_DIAMETER / 5 * MOTOR.KtNMPerAmp / MOTOR.rOhms);
  ...
  public static final Matrix<N7, N1> MEASUREMENT_STD_DEVS =
      VecBuilder.fill(
          0.001,
          0.001,
          0.001,
