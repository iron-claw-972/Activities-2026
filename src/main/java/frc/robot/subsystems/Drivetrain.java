...
public class Drivetrain extends SubsystemBase {
  ...
  public Drivetrain() {
    ...
    // TODO 2.1.1: Define DifferentialDrivetrainSim if the robot isn't real
      if (RobotBase.isReal()){
        driveSim= new DifferentialDrivetrainSim(DriveConstants.DRIVETRAIN_PLANT, DriveConstants.MOTOR, DriveConstants.GEAR_RATIO,DriveConstants.WHEEL_DIAMETER, DriveConstants.TRACK_WIDTH,DriveConstants.MEASUREMENT_STD_DEVS)
  }
